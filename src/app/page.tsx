      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex items-center justify-between h-10">
        ...
        <div className="flex items-center gap-4 text-white/60">
          ...
          <div className="flex items-center gap-3">
            ...
            <a
              href="https://www.facebook.com/p/Diamonds-Paving-100054463600286/"
              target="_blank"
              rel="noopener noreferrer"
              className="hover:text-blue transition-colors"
              aria-label="Facebook"
  ...
  return (
    ...
    >
      ...
      <div>
        ...
        <div className="text-sm font-semibold text-dark">5.0 Rating on Google</div>
        <div className="text-xs text-gray">Read our reviews &rarr;</div>
      </div>
    </a>
  );
}
        ...
        <div className="grid lg:grid-cols-2 gap-16">
          ...
          <div>
            ...
            <div className="mt-10 pt-8 border-t border-gray-200">
              <p className="text-sm text-gray mb-3">Follow us</p>
              <div className="flex items-center gap-4">
                <a
                  href="https://instagram.com/dpaving2019"
                  target="_blank"
                  rel="noopener noreferrer"
                  className="w-10 h-10 bg-gray-100 rounded-lg flex items-center justify-center text-dark hover:bg-blue hover:text-white transition-colors"
                  aria-label="Instagram"
                >
